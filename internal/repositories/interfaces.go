...
type ItemRepositoryInterface interface {
	...
	GetByType(ctx context.Context, mediaType models.MediaType) ([]models.Item, error)
	Update(ctx context.Context, item *models.Item) error
	Delete(ctx context.Context, id uint) error
	SearchByTitle(ctx context.Context, query string) ([]models.Item, error)
...
type UserItemRepositoryInterface interface {
	...
	GetByUserID(ctx context.Context, userID uint) ([]models.UserItem, error)
	...
	GetByStatus(ctx context.Context, userID uint, status models.MediaStatus) ([]models.UserItem, error)
	GetFavorites(ctx context.Context, userID uint) ([]models.UserItem, error)
